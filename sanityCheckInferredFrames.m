...
for cam_idx = 1:nCams
    ...
    for f = 1:length(predIdx) % predFrames
        reader.CurrentTime = predIdx(f) / frame_rate; % -1 bcs currentTime starts at 0 but preIdx frame starts at 1
...
v = VideoWriter(fullfile(vidPath,'rawAMB156_cache_1200_1400'),'MPEG-4');
v.Quality=95;
v.FrameRate = 10;
v.open,
...
save_file = 'LIM130_031626_E1_nF30'; 
...
save(fullfile(save_dir, 'LIM130_031626_E1nFrame30_v73_videos'), "camParams", "videos", "data_3D", "skeleton", '-v7.3')
